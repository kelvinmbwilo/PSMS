...
{{ Form::open(array("method"=>"post","url"=>url("reports/download"),"class"=>"form-horizontal","id"=>'formms')) }}
<div class='form-group' style="margin-bottom: 5px">
    ...
    <div class='col-sm-2'>
        Accident Main Causes<br>{{ Form::select('standard_description[]',StandardDescription::lists('name','id'),'',array('multiple'=>"multiple",'class'=>'form-control multi')) }}
    </div>
    <div class='col-sm-2'>
        Accident Detailed Causes<br><span id="district-area">{{ Form::select('standard[]',Standard::lists('name','id'),'',array('multiple'=>"multiple",'class'=>'form-control multi')) }}</span>
    </div>
...
<div class='form-group'>
    <div class='col-sm-2'>
        ...
        $arrayy = array(
            ...
            "Districts" => "Districts",
            "Car type" => "Car Type",
            "Offence Nature" => "Offence Nature",
            "Offence Section" => "Offence Section",
            "Offence Relating" => "Offence Relating",
            "Amount Paid" => "Amount Paid",
            "Licence Status" => "Licence Status",
            "Gender" => "Gender",
        );
        ?>
        Show<br>{{ Form::select('show[]',array('0'=>'General')+standard::lists('name','id'),'',array('class'=>'form-control multi')) }}
    </div>
    <div class='col-sm-2'>
        Drivers Gender<br>{{ Form::select('vertical',array("All"=>"All","Male"=>"Male","Female"=>"Female"),'',array('class'=>'form-control','required'=>'requiered')) }}
    </div>
    <div class='col-sm-4'>
        Horizontal<br>{{ Form::select('horizontal',array("Year"=>"Year","Years"=>"Years","Age Range"=>"Age Range","No of people"=>"No of people involved in the accident"),'',array('class'=>'form-control','required'=>'requiered')) }}
    </div>
...
<div class="col-xs-12" style="margin-top: 5px">
    ...
    <div class="col-md-2 btn btn-default btn-sm" id="column"><img src="{{ asset('column.png') }}" style="height: 20px;width: 20px" /> Column</div>
