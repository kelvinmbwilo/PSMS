...
<head>
    ...
    <title>PSMS system login page</title>
...
<div class="container">
    ...
    <form class="form-signin" action="{{ url('login') }}"  method="post">
        <div class="col-sm-6 col-sm-offset-3" style="padding-top: 55px">
        ...
        <div class="login-wrap">
            ...
            <input type="text" class="form-control" placeholder="rank number" autofocus name="rankNo">
