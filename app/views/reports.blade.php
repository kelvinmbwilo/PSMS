...
<div class='form-group' style="margin-bottom: 5px">
    ...
    <div class='col-sm-2'>
        Offence Nature<br><span id="district-area">{{ Form::select('offence[]',Offence::lists('nature','nature'),'',array('multiple'=>"multiple",'class'=>'form-control multi')) }}</span>
    </div>
    <div class='col-sm-2'>
        Offence Section<br>{{ Form::select('section[]',array('R.44'=>'R.44','R.43'=>'R.43','S.107'=>'S.107','R.32'=>'R.32'),'',array('multiple'=>"multiple",'class'=>'form-control multi')) }}
    </div>
    <div class='col-sm-2'>
