...
<!--    <link href="{{ asset('css/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css') }}" rel="stylesheet" type="text/css" />-->
    ...
    <link href="{{ asset('accident_includes/css/timepicker/bootstrap-timepicker.min.css')}}" rel="stylesheet"/>
    ...
    <link href="{{ asset('data-tables/DT_bootstrap.css') }}" rel="stylesheet"/>
     ...
     <!-- Theme style -->
<link href="{{ asset('accident_includes/css/AdminLTE.css')}}" rel="stylesheet" type="text/css" />
...
<!--            </div>-->
        ...
        <ul class="sidebar-menu">
          ...
          <li>
                <a href="{{ url('accident') }}">
                    <i class="fa fa-th"></i> <span>Report Accident</span>
                </a>
            </li>
...
<!-- Bootstrap -->
<script src="{{ asset('accident_includes/js/bootstrap.min.js')}}" type="text/javascript"></script>
...
<!-- InputMask -->
        <script src="{{ asset('accident_includes/js/plugins/input-mask/jquery.inputmask.js')}}" type="text/javascript"></script>
        <script src="{{ asset('accident_includes/js/plugins/input-mask/jquery.inputmask.date.extensions.js')}}" type="text/javascript"></script>
        <script src="{{ asset('accident_includes/js/plugins/input-mask/jquery.inputmask.extensions.js')}}" type="text/javascript"></script>


<!-- bootstrap time picker -->
        <script src="{{ asset('accident_includes/js/plugins/timepicker/bootstrap-timepicker.min.js')}}" type="text/javascript"></script>
